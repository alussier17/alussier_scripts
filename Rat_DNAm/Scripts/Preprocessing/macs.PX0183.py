...
### PX0183 ###
bamdir = '/home/alussier/newdata/PX0183/merged'
#setting directory to find unfiltered bam files
bamfiles = listdir_nohidden('/home/alussier/newdata/PX0183/merged/')
#telling python that every non-hidden file here is one of the files to use - bamfile
print bamfiles

macsdir = '/home/alussier/newdata/PX0183/macs/'
...
for bamfile in bamfiles:
    ...
    macsfile = bamfile.split('/')[-1].replace('PX0183_C5DN1ANXX_7_','')
...
macs_broaddir = '/home/alussier/newdata/PX0183/macs_broad/'
try:
