...
library(readxl)
med.data <- read_excel("Mediation_sites_all_2021-06-04.xls")
...
# save changes
#save(med.data, file = "Mediation_sites_2021-06-06.Rdata")
#write.csv(med.data, file = "Mediation_sites_2021-06-06.csv")