...
load(paste0("med_step2_inputs/inputs_",timepoint,"_", 
            Sys.Date()-1,".Rdata"))
...
load(paste0("fit.grid2s_SMFQ_10y/fit.grid2_",timepoint,"_2021-03-26",".Rdata"))
...
write.csv(sum.fit.lam0, paste0("output/summ.fit.lam0.",timepoint,"_",Sys.Date(),".csv"))
...
write.csv(sum.fit.lavaan, paste0("output/summ.fit.lavaan.",timepoint,"_",Sys.Date(),".csv"))
