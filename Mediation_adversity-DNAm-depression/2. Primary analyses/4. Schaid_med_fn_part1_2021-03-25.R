...
schaid_mediation_reduc_probes_p1 <- function(adver, timepoint){
  ...
  load(paste0("adjusted_mvalues_w_covs_",timepoint,"_2021-03-25.Rdata"))
  ...
  save(inputs, file = paste0("inputs_",timepoint,"_", 
                             Sys.Date(),".Rdata"))
 ...
 save(fit.grid, file = paste0("fit.grids_SMFQ_10y/fit.grid_",timepoint,"_", 
                              Sys.Date(),".Rdata"))
  ...
  save(fit.grid2, file = paste0("fit.grid2s_SMFQ_10y/fit.grid2_",timepoint,"_", 
                               Sys.Date(),".Rdata"))
